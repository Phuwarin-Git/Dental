...
const ToolModal = () => {
    ...
    function submitForm(
        ...
        const ApiSet = ({
            ToolId: ToolId,
            papercenter_endo: papercenter_endo,
            EndoBursBox: EndoBursBox,
            HF32MM1540_endo: HF32MM1540_endo,
            cloth_endo: cloth_endo,
            ColorBarbedbrodch_endo: ColorBarbedbrodch_endo,
            Barbedbrodch_endo: Barbedbrodch_endo,
            HF23MM4580_endo: HF23MM4580_endo,
            WATER_endo: WATER_endo,
            ColorLentuloSpiral_endo: ColorLentuloSpiral_endo,
            Lentulospiral_endo: Lentulospiral_endo,
            HF25MM1540_endo: HF25MM1540_endo,
            Examinationkit_endo: Examinationkit_endo,
            PROH21MM_endo: PROH21MM_endo,
            HF25MM4580_endo: HF25MM4580_endo,
            Tripplesyringe_endo: Tripplesyringe_endo,
            PROH25MM_endo: PROH25MM_endo,
            WATER2o_endo: WATER2o_endo,
            HGateDrillF_endo: HGateDrillF_endo,
            NF21MM1540_endo: NF21MM1540_endo,
            Mouthprop_endo: Mouthprop_endo,
            HGateDrillB_endo: HGateDrillB_endo,
            NF21MM4560_endo: NF21MM4560_endo,
            Syringe_endo: Syringe_endo,
            Syringe5ML_endo: Syringe5ML_endo,
            NF25MM1540_endo: NF25MM1540_endo,
            Cottonswab_endo: Cottonswab_endo,
            Needlewash2427_endo: Needlewash2427_endo,
            NF25MM4560_endo: NF25MM4560_endo,
            Airotor_endo: Airotor_endo,
            RootZx_endo: RootZx_endo,
            Contra_endo: Contra_endo,
            Glasslab_endo: Glasslab_endo,
            KF21MM840_endo: KF21MM840_endo,
            FileStand_endo: FileStand_endo,
            HighPowerSuction_endo: HighPowerSuction_endo,
            KF21MM4580_enod: KF21MM4580_enod,
            NumberPlatePP_endo: NumberPlatePP_endo,
            PlatePP_endo: PlatePP_endo,
            OCBOXSET_endo: OCBOXSET_endo,
            KF25MM840_endo: KF25MM840_endo,
            RubberdamFlame_endo: RubberdamFlame_endo,
            FRCBOXSET_endo: FRCBOXSET_endo,
            KF25MM4580_endo: KF25MM4580_endo,
            RubberdamSheet_endo: RubberdamSheet_endo,
            NumberCF21_endo: NumberCF21_endo,
            CF21_endo: CF21_endo,
            KF30MM840_endo: KF30MM840_endo,
            NumberCLAMP_endo: NumberCLAMP_endo,
            CLAMP_endo: CLAMP_endo,
            NumberCF25_endo: NumberCF25_endo,
            CF25_endo: CF25_endo,
            KF30MM4580_endo: KF30MM4580_endo,
            Examinationkit_n: Examinationkit_n,
            COMPOSIT_n: COMPOSIT_n,
            RUBBERD_n: RUBBERD_n,
            WATTERP_n: WATTERP_n,
            ANALGAM_n: ANALGAM_n,
            CLAMPNO_n: CLAMPNO_n,
            CLAMPP_n: CLAMPP_n,
            TRIPPLES_n: TRIPPLES_n,
            SETCOMPOSITSLOW_n: SETCOMPOSITSLOW_n,
            HSTELLSLOW_n: HSTELLSLOW_n,
            Centerpunchingfabric_n: Centerpunchingfabric_n,
            SETCOMPOSITFAST_n: SETCOMPOSITFAST_n,
            SETASTROPOL_n: SETASTROPOL_n,
            Clothcover_n: Clothcover_n,
            PLSCOMPOSIT_n: PLSCOMPOSIT_n,
            IVORYTOFFMATRIX_n: IVORYTOFFMATRIX_n,
            UNC15P_n: UNC15P_n,
            SPOONEXCABIG_n: SPOONEXCABIG_n,
            HIGHTPSUCTION_n: HIGHTPSUCTION_n,
            Liquidcup_n: Liquidcup_n,
            MATRIXV3RNo_n: MATRIXV3RNo_n,
            MATRIXV3R_n: MATRIXV3R_n,
            DAPPEND_n: DAPPEND_n,
            MATRIXV3FORCEPNo_n: MATRIXV3FORCEPNo_n,
            MATRIXV3FORCEP_n: MATRIXV3FORCEP_n,
            MOUTHPROP_n: MOUTHPROP_n,
            ROUNDDIBURNo_n: ROUNDDIBURNo_n,
            ROUNDDIBUR_n: ROUNDDIBUR_n,
            GLASSLAB_n: GLASSLAB_n,
            CYLINDERDIBURSNo_n: CYLINDERDIBURSNo_n,
            CYLINDERDIBURS_n: CYLINDERDIBURS_n,
            AIROTORP_n: AIROTORP_n,
            ROUNDDIBURFNo_n: ROUNDDIBURFNo_n,
            ROUNDDIBURF_n: ROUNDDIBURF_n,
            CONTRA_n: CONTRA_n,
            CYLINDERDIBURFNo_n: CYLINDERDIBURFNo_n,
            CYLINDERDIBURF_n: CYLINDERDIBURF_n,
            Cottonswab_n: Cottonswab_n,
            DYCALC_n: DYCALC_n,
            RUPPERCTBNo_n: RUPPERCTBNo_n,
            RUPPERCTB_n: RUPPERCTB_n,
            SPATULAPLASTIC_n: SPATULAPLASTIC_n,
            SYRING_n: SYRING_n,
            CEMENTS_n: CEMENTS_n,
            BLADEHO_n: BLADEHO_n,
            MENDREL_n: MENDREL_n,
