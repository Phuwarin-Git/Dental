...
import './whycss.css'
import StyleModal from './historyModal/historyCss'
                        ...
                        <Card border="dark" style={{ width: '400px', fontFamily: "Mitr, sans-serif,Noto Sans Thai Looped,sans-serif" }}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <Container>
                                        <Row>
                                            <Col><p>Date : {details[0]?.date}</p></Col>
                                            <Col><p>Clinic : {details[0]?.clinic}</p></Col>
                                        </Row>
                                        <Row>
                                            <Col><p>Name : {details[0]?.name}</p> </Col>
                                            <Col><p>Year : {details[0]?.year}</p> </Col>
                                        </Row>
                                        <Row>
                                            <Col><p>Work Type : {details[0]?.worktype}</p></Col>
                                            <Col><p>Unit : {details[0]?.unit}</p></Col>

                                        </Row>
                                        <Row>
                                            <Col><p>dn : {details[0]?.dn}</p></Col>
                                            <Col><p>hn : {details[0]?.hn}</p></Col>
                                        </Row>
                                        <Row>
                                            <Col><p>Patient : {details[0]?.patient}</p></Col>
                                        </Row>
                                    </Container>
                                    <Card.Title style={{ color: '#0080ff', textAlign: 'center', fontSize: '25px' }}>รายการอุปกรณ์</Card.Title>
                                    <p>สถานะการจองอุปกรณ์ : <Button style={{ backgroundColor: '#2bc42b', color: 'black' }}>{details[0]?.toolStatus}</Button></p>
                                    <Container>
                                        <Table
                                            striped
                                            bordered
